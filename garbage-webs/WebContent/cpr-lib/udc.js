...
/// start - udc.aaa.wpm
/*
 * UDC Qualified Name: udc.aaa.wpm
 * App URI: udc/aaa/wpm
 * Source Location: udc/aaa/wpm.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	// App Declaration
	var internalApp = new cpr.core.App("udc/aaa/wpm", {
		onPrepare: function(loader){
		},
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			var linker = {};
			...
			/************************************************
			 * wpm.js
			 * Created at 2022. 1. 4. 오후 4:31:20.
			 *
			 * @author HANS
			 ************************************************/
			...
			// Header
			app.declareAppProperty("textMan", "기본값");
			...
			var output_1 = new cpr.controls.Output("opt1");
			output_1.value = "Output";
			output_1.bind("value").toAppProperty("textMan");
			container.addChild(output_1, {
				"top": "56px",
				"left": "20px",
				"width": "100px",
	...
	cpr.utils.Util.ensurePackage("udc.aaa").wpm = function(id){
		cpr.controls.UDCBase.call(this, "udc.aaa.wpm", internalApp, id);
	};
	
	udc.aaa.wpm.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.aaa.wpm.prototype, "type", {
		get : function(){
			return "udc.aaa.wpm";
		},
	...
	// App Properties
	Object.defineProperty(udc.aaa.wpm.prototype, "textMan", {
		get: function(){
			return this.getEmbeddedAppInstance().getAppProperty("textMan");
		},
		set: function(newValue){
			return this.getEmbeddedAppInstance().setAppProperty("textMan", newValue, true);
		}
	});
...
/// start - udc.com.Untitled
/*
 * UDC Qualified Name: udc.com.Untitled
 * App URI: udc/com/Untitled
 * Source Location: udc/com/Untitled.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	// App Declaration
	var internalApp = new cpr.core.App("udc/com/Untitled", {
		onPrepare: function(loader){
		},
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			var linker = {};
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"label": "label1", "value": "value1", "filt": "1"},
					{"label": "label2", "value": "value2", "filt": "1"},
					{"label": "label3", "value": "value3", "filt": "2"},
					{"label": "label4", "value": "value4", "filt": "3"},
					{"label": "직접입력", "value": "value5", "filt": "0"}
				]
			});
			app.register(dataSet_1);
			...
			radioButton_1.filterExp = "filt == column4 || filt == 0";
			(function(radioButton_1){
				radioButton_1.setItemSet(app.lookup("ds2"), {
					"label": "label",
					"value": "value"
				})
			})(radioButton_1);
	...
	cpr.utils.Util.ensurePackage("udc.com").Untitled = function(id){
		cpr.controls.UDCBase.call(this, "udc.com.Untitled", internalApp, id);
	};
	
	udc.com.Untitled.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.com.Untitled.prototype, "type", {
		get : function(){
			return "udc.com.Untitled";
		},
	...
	var internalApp = new cpr.core.App("udc/udcCntyCd", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				if(typeof onIpbCntyNmValueChange == "function") {
					inputBox_1.addEventListener("value-change", onIpbCntyNmValueChange);
				}
				container.addChild(inputBox_1, {
					"colIndex": 1,
					"rowIndex": 0
