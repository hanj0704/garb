...
function onBodyLoad( /* cpr.events.CEvent */ e) {
	...
	console.log(app.lookup("grd1").getCellValue(1, 2));
}
...
//				context.data = context.source.detail;
				context.data = control.getRow(context.sourceTargetObject.rowIndex).getValue(context.sourceTargetObject.columnName);
				console.log(context.sourceTargetObject);
				feedback.value = JSON.stringify(control.getRow(context.sourceTargetObject.rowIndex).getValue(context.sourceTargetObject.columnName));
...
//				control2.insertRowData(context.target.detail.rowIndex, true, context.source.control.getRow(context.data.rowIndex).getRowData());
				...
				a.setCellValue(context.target.detail.rowIndex, context.target.detail.cellIndex, context.data);
			} 
//			else {
