/*
 * App URI: 201909/PivotExam
 * Source Location: 201909/PivotExam.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("201909/PivotExam", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			submission_1.action = "data/pf3/pivot-raw.json";
			...
			(function(container){
				var userDefinedControl_1 = linker.userDefinedControl_1 = new udc.com.PivotHelper("pivothelper1");
				if(typeof onPivothelper1Update == "function") {
					userDefinedControl_1.addEventListener("update", onPivothelper1Update);
				}
							...
							"cells": [
								{
									"constraint": {"rowIndex": 0, "colIndex": 0},
									"configurator": function(cell){
										cell.columnName = "R_CAT";
										cell.control = (function(){
											var inputBox_1 = new cpr.controls.InputBox("ipb1");
											inputBox_1.bind("value").toDataColumn("R_CAT");
											return inputBox_1;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 1},
									"configurator": function(cell){
										cell.columnName = "C_CAT1";
										cell.control = (function(){
											var inputBox_2 = new cpr.controls.InputBox("ipb2");
											inputBox_2.bind("value").toDataColumn("C_CAT1");
											return inputBox_2;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 2},
									"configurator": function(cell){
										cell.columnName = "C_CAT2";
										cell.control = (function(){
											var inputBox_3 = new cpr.controls.InputBox("ipb3");
											inputBox_3.bind("value").toDataColumn("C_CAT2");
											return inputBox_3;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 3},
									"configurator": function(cell){
										cell.columnName = "C_CAT3";
										cell.control = (function(){
											var inputBox_4 = new cpr.controls.InputBox("ipb4");
											inputBox_4.bind("value").toDataColumn("C_CAT3");
											return inputBox_4;
										})();
									}
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											numberEditor_1.bind("value").toDataColumn("VALUE");
								...
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 5},
									"configurator": function(cell){
										cell.columnName = "DUMMY1";
										cell.control = (function(){
											var inputBox_5 = new cpr.controls.InputBox("ipb5");
											inputBox_5.bind("value").toDataColumn("DUMMY1");
											return inputBox_5;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 6},
									"configurator": function(cell){
										cell.columnName = "DUMMY2";
										cell.control = (function(){
											var inputBox_6 = new cpr.controls.InputBox("ipb6");
											inputBox_6.bind("value").toDataColumn("DUMMY2");
											return inputBox_6;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 7},
									"configurator": function(cell){
										cell.columnName = "DUMMY3";
										cell.control = (function(){
											var inputBox_7 = new cpr.controls.InputBox("ipb7");
											inputBox_7.bind("value").toDataColumn("DUMMY3");
											return inputBox_7;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 8},
									"configurator": function(cell){
										cell.columnName = "DUMMY4";
										cell.control = (function(){
											var inputBox_8 = new cpr.controls.InputBox("ipb8");
											inputBox_8.bind("value").toDataColumn("DUMMY4");
											return inputBox_8;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 9},
									"configurator": function(cell){
										cell.columnName = "DUMMY5";
										cell.control = (function(){
											var inputBox_9 = new cpr.controls.InputBox("ipb9");
											inputBox_9.bind("value").toDataColumn("DUMMY5");
											return inputBox_9;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 10},
									"configurator": function(cell){
										cell.columnName = "DUMMY6";
										cell.control = (function(){
											var inputBox_10 = new cpr.controls.InputBox("ipb10");
											inputBox_10.bind("value").toDataColumn("DUMMY6");
											return inputBox_10;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 11},
									"configurator": function(cell){
										cell.columnName = "DUMMY7";
										cell.control = (function(){
											var inputBox_11 = new cpr.controls.InputBox("ipb11");
											inputBox_11.bind("value").toDataColumn("DUMMY7");
											return inputBox_11;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 12},
									"configurator": function(cell){
										cell.columnName = "DUMMY8";
										cell.control = (function(){
											var inputBox_12 = new cpr.controls.InputBox("ipb12");
											inputBox_12.bind("value").toDataColumn("DUMMY8");
											return inputBox_12;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 13},
									"configurator": function(cell){
										cell.columnName = "DUMMY9";
										cell.control = (function(){
											var inputBox_13 = new cpr.controls.InputBox("ipb13");
											inputBox_13.bind("value").toDataColumn("DUMMY9");
											return inputBox_13;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 14},
									"configurator": function(cell){
										cell.columnName = "DUMMY10";
										cell.control = (function(){
											var inputBox_14 = new cpr.controls.InputBox("ipb14");
											inputBox_14.bind("value").toDataColumn("DUMMY10");
											return inputBox_14;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 15},
									"configurator": function(cell){
										cell.columnName = "DUMMY11";
										cell.control = (function(){
											var inputBox_15 = new cpr.controls.InputBox("ipb15");
											inputBox_15.bind("value").toDataColumn("DUMMY11");
											return inputBox_15;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 16},
									"configurator": function(cell){
										cell.columnName = "DUMMY12";
										cell.control = (function(){
											var inputBox_16 = new cpr.controls.InputBox("ipb16");
											inputBox_16.bind("value").toDataColumn("DUMMY12");
											return inputBox_16;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 17},
									"configurator": function(cell){
										cell.columnName = "DUMMY13";
										cell.control = (function(){
											var inputBox_17 = new cpr.controls.InputBox("ipb17");
											inputBox_17.bind("value").toDataColumn("DUMMY13");
											return inputBox_17;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 18},
									"configurator": function(cell){
										cell.columnName = "DUMMY14";
										cell.control = (function(){
											var inputBox_18 = new cpr.controls.InputBox("ipb18");
											inputBox_18.bind("value").toDataColumn("DUMMY14");
											return inputBox_18;
										})();
									}
								},
								{
									"constraint": {"rowIndex": 0, "colIndex": 19},
									"configurator": function(cell){
										cell.columnName = "DUMMY15";
										cell.control = (function(){
											var inputBox_19 = new cpr.controls.InputBox("ipb19");
											inputBox_19.bind("value").toDataColumn("DUMMY15");
											return inputBox_19;
										})();
									}
								}
