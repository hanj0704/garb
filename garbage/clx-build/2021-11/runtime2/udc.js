...
(function(){
	...
	var internalApp = new cpr.core.App("udc/HansTest", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// UI Configuration
			var group_1 = new cpr.controls.Container("grpLP1");
			...
			group_1.setLayout(xYLayout_2);
			(function(container){
				var output_1 = new cpr.controls.Output("LP1Foup");
				output_1.style.setClasses(["factory-cassette", "text-center"]);
				output_1.bind("enabled").toExpression("getOriginalValue(column1)");
				container.addChild(output_1, {
					"top": "20px",
					"left": "7px",
					"width": "180px",
